...
local function moody(msg, matches)
  ...
  for k, v in pairs( plugins_names( )) do
      -- get the name
      v = string.match (v, "(.*)%.lua")
      		tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, "./plugins/"..v..".lua", '🌐║ تابع قناه السورس @Y3SOO\n👨🏽‍🔧', dl_cb, nil)
...
tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, "./plugins/"..file..".lua", ' تابع قناه السورس @Y3SOO\n👨🏽‍🔧', dl_cb, nil)
end
end
end
...
tdcli.sendDocument(msg.chat_id_, msg.id_,0, 1, nil, send_file, ' تابع قناه السورس @Y3SOO\n👨🏽‍🔧', dl_cb, nil)
end
...
tdcli.sendDocument(msg.from.id,0,0, 1, nil, "./data/moderation.json", ' يحتوي الملف على '..i..' مجموعات مفعلهه\n🌐║ تابع قناه السورس @Y3SOO\n👨🏽‍🔧', dl_cb, nil)
