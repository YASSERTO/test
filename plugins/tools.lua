...
if (lock_brod == "no" or tonumber(msg.from.id) ~= tonumber(SUDO)) then return "هذا الاوامر للمطور الاساسي فقط 🌐║" end
...
⚜️╣ٴ═════════
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ الكل
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ المجموعه
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ الجهات
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ التوجيه
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋التكرار
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ الكلايش
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ البوتات بالطرد
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ البوتات
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ التاك
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ الروابط
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ الملصقات
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ الدردشه
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ المتحركه
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ الصوت
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ الصور
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ الفيديو
🌐║  _قفل_ 🔒┋_فتح_ 🔓┋ التعديل
...
⚜️╣ٴ═════════
🌐║ 🔺اوامـر المطور فقط 🔻
🌐║ الردود العام ⇠  لعرض الردود
🌐║ رد اضف عام ⇠  أضافةرد جديد
🌐║ رد مسح عام ⇠ المراد مسحه
🌐║ رد مسح الكل ⇠ لمسح الكل
⚜️╣ٴ═════════
...
🌐║ تحديث السورس ⇜ يحدث↯
🌐║ [السورس الى الاصدار الجديد]
🌐║ نسخه احتياطيه ⇜ لجلب ↯
🌐║ نسخه الكروبات لحفظ امن البوت]
