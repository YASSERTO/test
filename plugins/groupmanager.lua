...
tdcli.sendMessage(msg.to.id, 0, 1, '🌐║ تـم تـفـعـيـل الـمـجـمـوعـه ☑️', 1, 'html')
else
tdcli.sendMessage(SUDO, 0, 1, '🌐║  قام احد المطورين بتفعيل البوت 🃏\n🌐║  `'..escape_markdown(msg.to.title) ..'️`\n🌐║  ايدي المجموعه : `'..msg.to.id..'`\n🌐║  بواسطة : '..escape_markdown(msg.from.first_name) ..'\n🌐║  معرفه : @'..(check_markdown(msg.from.username) or "---"), 1, 'md')
tdcli.sendMessage(msg.to.id, 0, 1, '🌐║ تـم تـفـعـيـل الـمـجـمـوعـه ☑️', 1, 'html')
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║  _ تمت ترقيته ليصبح ضمن عضو مميز ☑️_\n🌐║  _العضو_ ['..user_name..'] \n🌐║  _الايدي_ *['..data.id_..']*', 0, "md")
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ انه بالتأكيد ليس من عضو مميز ☑️ _\n🌐║ _العضو_ ['..user_name..']\n🌐║ _ الايدي _*['..data.id_..']*', 0, "md")

end
administration[tostring(arg.chat_id)]['whitelist'][tostring(data.id_)] = nil
save_data(_config.moderation.data, administration)

return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تمت تنزيله من عضو مميز ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_ *['..data.id_..']*', 0, "md")
end
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ انه بالتأكيد مدير ☑️ _\n🌐║ _العضو_ ['..user_name..']\n🌐║ _ الايدي _*['..data.id_..']*', 0, "md")
end

administration[tostring(arg.chat_id)]['owners'][tostring(data.id_)] = user_name
save_data(_config.moderation.data, administration)

return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تمت ترقيته ليصبح مدير ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_ *['..data.id_..']*', 0, "md")
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ انه بالتأكيد ادمن ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _ الايدي _*['..data.id_..']*', 0, "md")
end

administration[tostring(arg.chat_id)]['mods'][tostring(data.id_)] = user_name
save_data(_config.moderation.data, administration)

return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تمت ترقيته ليصبح ادمن ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _ الايدي _*['..data.id_..']*', 0, "md")
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _انه بالتأكيد ليس مدير ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_ *['..data.id_..']*', 0, "md")
end

administration[tostring(arg.chat_id)]['owners'][tostring(data.id_)] = nil
save_data(_config.moderation.data, administration)

return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _تم تنزيله من الاداره ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_ *['..data.id_..']*', 0, "md")
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _انه بالتأكيد ليس ادمن ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _ الايدي _*['..data.id_..']*', 0, "md")

end
administration[tostring(arg.chat_id)]['mods'][tostring(data.id_)] = nil
save_data(_config.moderation.data, administration)

return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _تم تنزيله من الادمنيه ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _ الايدي_ *['..data.id_..']*', 0, "md")
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ انه بالتأكيد من عضو مميز ☑️ _\n🌐║ _العضو_ ['..user_name..']\n🌐║ _ الايدي _*['..data.id_..']*', 0, "md")
end
...
return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ انه بالتأكيد ليس من عضو مميز ☑️ _\n🌐║ _العضو_ ['..user_name..']\n🌐║ _ الايدي _*['..data.id_..']*', 0, "md")

end
administration[tostring(arg.chat_id)]['whitelist'][tostring(data.id_)] = nil
save_data(_config.moderation.data, administration)

return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ تمت تنزيله من عضو مميز ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_ *['..data.id_..']*', 0, "md")
...
if administration[tostring(arg.chat_id)]['whitelist'][tostring(data.id_)] then
return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ انه بالتأكيد من عضو مميز ☑️ _\n🌐║ _العضو_ ['..user_name..']\n🌐║ _ الايدي _*['..data.id_..']*', 0, "md")
...
return '🌐║ _اذاعه المطورين بالتاكيد تم تعطيله ☑️_'
else
data[tostring(target)]["settings"]["lock_brod"] = "no"
save_data(_config.moderation.data, data)
return '🌐║ _تم تعطيل اذاعه المطورين  ☑️_'
end
end
...
return '🌐║ _اذاعه المطورين بالتاكيد تم تفعيله ☑️_'
else
data[tostring(target)]["settings"]["lock_brod"] = "yes"
save_data(_config.moderation.data, data)
return '🌐║ _تم تفعيل اذاعه المطورين  ☑️_'
end
end
...
if replay == "🔓" then
return '🌐║ _الردود بالتاكيد تم تعطيله ☑️_'
else
data[tostring(target)]["settings"]["replay"] = "🔓"
save_data(_config.moderation.data, data)
return '🌐║ _تم تعطيل الردود  ☑️_'
end
end
...
local replay = data[tostring(target)]["settings"]["replay"]
if replay == "🔒" then
return '🌐║ _الردود بالتاكيد تم تفعيله ☑️_'
else
data[tostring(target)]["settings"]["replay"] = "🔒"
save_data(_config.moderation.data, data)
return '🌐║ _تم تفعيل الردود  ☑️_'
end
end
...
if lock_link == "🔒" then
return '🌐║ _الروابط بالتأكيد تم قفلها_ ☑️'
else
data[tostring(target)]["settings"]["lock_link"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الروابط_ ☑️'
...
return '🌐║ _التاك(#) بالتأكيد تم قفله_ ☑️'

else
data[tostring(target)]["settings"]["lock_tag"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل التاك(#)_ ☑️'
...
return '🌐║ _التذكير بالتأكيد تم قفله_ ☑️'

else
data[tostring(target)]["settings"]["lock_mention"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل التذكير_ ☑️'
...
return '🌐║ _التعديل بالتأكيد تم قفله_ ☑️'

else
data[tostring(target)]["settings"]["lock_edit"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل التعديل_ ☑️'
...
local lock_edit = data[tostring(target)]["settings"]["lock_edit"]
if lock_edit == "🔓" then
return '🌐║ _التعديل بالتأكيد تم فتحه_ ☑️'
else
...
return '🌐║ _الكلايش بالتأكيد تم قفلها_ ☑️'

else
data[tostring(target)]["settings"]["lock_spam"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الكلايش_ ☑️'
...
return '🌐║ _الكلايش بالتأكيد تم فتحها_ ☑️'

else
data[tostring(target)]["settings"]["lock_spam"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح الكلايش_ ☑️'
...
return '🌐║ _التكرار بالتأكيد تم قفله_ ☑️'

else
data[tostring(target)]["settings"]["flood"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل التكرار_ ☑️'
...
return '🌐║ _البوتات بالتأكيد تم قفلها_ ☑️'

else
data[tostring(target)]["settings"]["lock_bots"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل البوتات_ ☑️'
...
return '🌐║ _الاضافه بالتاكيد تم قفلها  _ ☑️'

else
data[tostring(target)]["settings"]["lock_join"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الاضافه_ ☑️'
...
return '🌐║ _الاضافه بالتاكيد تم فتحها  _ ☑️'

else
data[tostring(target)]["settings"]["lock_join"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح الاضافه_ ☑️'
...
return '🌐║ _الماركدوان بالتاكيد تم قفله _ ☑️'

else
data[tostring(target)]["settings"]["lock_markdown"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الماركدوان_ ☑️'
...
return '🌐║ _الويب بالتأكيد تم قفله_ ☑️'

else
data[tostring(target)]["settings"]["lock_webpage"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الويب_☑️'
...
return '🌐║ _الويب بالتأكيد تم فتحه_ ☑️'

else
data[tostring(target)]["settings"]["lock_webpage"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح الويب_ ☑️'
...
return '🌐║ _التثبيت بالتأكيد تم قفله_ ☑️'

else
data[tostring(target)]["settings"]["lock_pin"] = "🔒"
save_data(_config.moderation.data, data)

return "🌐║ _تم قفل التثبيت_☑️"
...
return '🌐║ _التثبيت بالتأكيد تم فتحه_ ☑️'

else
data[tostring(target)]["settings"]["lock_pin"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح التثبيت_ ☑️'
...
return '🌐║ _المتحركه بالتأكيد تم قفلها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_gif"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل المتحركه_ ☑️'
...
local mute_gif = data[tostring(target)]["mutes"]["mute_gif"]
if mute_gif == "🔓" then
return '🌐║ _المتحركه بالتأكيد تم فتحها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_gif"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح المتحركه_ ☑️'
...
return '🌐║ _الالعاب بالتأكيد تم قفلها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_game"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الالعاب_ ☑️'
...
return '🌐║ _الألعاب بالتأكيد تم فتحها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_game"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح الألعاب_ ☑️'
...
return '🌐║ _الانلاين بالتأكيد تم قفله_ ☑️'

else
data[tostring(target)]["mutes"]["mute_inline"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الانلاين_ ☑️'
...
return '🌐║ _الانلاين بالتأكيد تم فتحه_ ☑️'

else
data[tostring(target)]["mutes"]["mute_inline"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح الانلاين_ ☑️'
...
if mute_text == "🔒" then
return '🌐║ _الدرشه بالتأكيد تم قفلها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_text"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الدردشه_ ☑️'
...
return '🌐║ _الدردشه بالتأكيد تم فتحها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_text"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح الدردشه_ ☑️'
...
return '🌐║ _الصور بالتأكيد تم قفلها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_photo"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الصور_ ☑️'
...
return '🌐║ _الصور بالتأكيد تم فتحها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_photo"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح الصور_ ☑️'
...
return '🌐║ _الفيديو بالتأكيد تم قفلها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_video"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الفيديو_ ☑️'
...
return '🌐║ _الفيديو بالتاكيد تم فتحها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_video"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح الفيديو_ ☑️'
end
end
---------------Mute Audio-------------------
...
return '🌐║ _البصمات بالتأكيد تم قفلها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_audio"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل البصمات_ ☑️'
...
return '🌐║ _البصمات بالتأكيد تم فتحها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_audio"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح البصمات_ ☑️'
...
return '🌐║ _الصوت بالتأكيد تم قفله_ ☑️'

else
data[tostring(target)]["mutes"]["mute_voice"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الصوت_ ☑️'
end
...
return '🌐║ _الصوت بالتأكيد تم فتحه_ ☑️'

else
data[tostring(target)]["mutes"]["mute_voice"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║  _تم فتح الصوت_ ☑️'
...
return '🌐║ _الملصقات بالتأكيد تم قفلها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_sticker"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الملصقات_ ☑️'
...
return '🌐║ _الملصقات بالتأكيد تم فتحها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_sticker"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح الملصقات_ ☑️'
...
return '🌐║ _جهات الاتصال بالتأكيد تم قفلها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_contact"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل جهات الاتصال_ ☑️'
...
return '🌐║ _جهات الاتصال بالتأكيد تم فتحها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_contact"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح جهات الاتصال_ ☑️'
...
return '🌐║ _التوجيه بالتأكيد تم قفلها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_forward"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل التوجيه_ ☑️'
...
local mute_forward = data[tostring(target)]["mutes"]["mute_forward"]
if mute_forward == "🔓" then
return '🌐║ _التوجيه بالتأكيد تم فتحها_ ☑️'
else
data[tostring(target)]["mutes"]["mute_forward"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح التوجيه_ ☑️'
end
end
---------------Mute Location-------------------
...
return '🌐║  _الموقع بالتأكيد تم قفله_ ☑️'

else
data[tostring(target)]["mutes"]["mute_location"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الموقع_ ☑️'
...
return '🌐║ _الموقع بالتأكيد تم فتحه_ ☑️'

else
data[tostring(target)]["mutes"]["mute_location"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح الموقع_ ☑️'
...
return '🌐║ _الملفات بالتأكيد تم قفلها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_document"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الملفات_ ☑️'
...
return '🌐║ _الملفات بالتأكيد تم فتحها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_document"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح الملفات_ ☑️'
...
return '🌐║ _الاشعارات بالتأكيد تم فتحها_ ☑️'

else
data[tostring(target)]["mutes"]["mute_tgservice"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الاشعارات_ ☑️'
end
end
...
return '🌐║ _الكيبورد بالتأكيد تم قفله_ ☑️'

else
data[tostring(target)]["mutes"]["mute_keyboard"] = "🔒"
save_data(_config.moderation.data, data)

return '🌐║ _تم قفل الكيبورد_ ☑️'
...
return '🌐║ _الكيبورد بالتأكيد تم فتحه_ ☑️'

else
data[tostring(target)]["mutes"]["mute_keyboard"] = "🔓"
save_data(_config.moderation.data, data)

return '🌐║ _تم فتح الكيبورد_ ☑️'
...
return "🌐║ _ تم الغاء تثبيت الرساله_ ☑️"
...
return "🌐║ _رجائا ارسل الرابط الآن _🔃"
...
return "🌐║ _تم حفظ الرابط بنجاح _☑️"
...
return "🌐║ _تم ارسال الرابط خاص لك _🔃"
...
return "🌐║ _تم حذف الكلمات الممنوعه بنجاح_ ☑️"
...
return "🌐║ _تم حذف القوانين بنجاح_ ☑️"
...
return "🌐║ _تم حذف الترحيب بنجاح_ ☑️"
...
return "🌐║ _تم تعيين صوره للمجموعه_ ☑️"
else
...
if lock_id == "🔒" then
return "🌐║ _امر الايدي شغال بالفعل_ ☑️"
else
data[tostring(chat)]['settings']['lock_id'] = "🔒"
save_data(_config.moderation.data, data)
return "🌐║ _تم تفعيل امر الايدي_ ☑️"
end
end
...
if welcome == "🔒" then
return "🌐║ _تفعيل الترحيب مفعل مسبقاً_ ☑️"
else
data[tostring(chat)]['settings']['welcome'] = "🔒"
save_data(_config.moderation.data, data)
return "🌐║ _تم تفعيل الترحيب_ ☑️"
end
end
...
if lock_woring == "🔒" then
return "🌐║ _تفعيل التحذير مفعل مسبقاً_ ☑️"
else
data[tostring(chat)]['settings']['lock_woring'] = "🔒"
save_data(_config.moderation.data, data)
return "🌐║ _تم تفعيل التحذير_ ☑️"
end
end
end
...
lock_id = data[tostring(chat)]['settings']['lock_id']
if lock_id == "🔓" then
return "🌐║ _الايدي بالتأكيد معطل_ ☑️"
else
data[tostring(chat)]['settings']['lock_id'] = "🔓"
save_data(_config.moderation.data, data)
return "🌐║ _تم تعطيل امر الايدي_ ☑️"
end
end
...
welcome = data[tostring(chat)]['settings']['welcome']
if welcome == "🔓" then
return "🌐║ _الترحيب بالتأكيد معطل_ ☑️"
else
data[tostring(chat)]['settings']['welcome'] = "🔓"
save_data(_config.moderation.data, data)
return "🌐║ _تم تعطيل الترحيب_ ☑️"
end
end
...
lock_woring = data[tostring(chat)]['settings']['lock_woring']
if lock_woring == "🔓" then
return "🌐║ _التحذير بالتأكيد معطل_ ☑️"
else
data[tostring(chat)]['settings']['lock_woring'] = "🔓"
save_data(_config.moderation.data, data)
return "🌐║ _تم تعطيل التحذير_ ☑️"
end
end
end
