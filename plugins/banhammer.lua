...
tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم حظره ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_* ['..data.id_..']*', 0, "md")
kick_user(data.id_, arg.chat_id)
end

if is_gbanned(data.id_) then
tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم حظره عام ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_* ['..data.id_..']*', 0, "md")
kick_user(data.id_, arg.chat_id)
end
end
...
if administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
     return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم بالتأكيد حظره ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_* ['..data.id_..']*', 0, "md")
   end
administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] = user_name
    save_data(_config.moderation.data, administration)
   kick_user(data.id_, arg.chat_id)
    return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم حظره ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_* ['..data.id_..']*', 0, "md")
end
tdcli_function ({
    ID = "GetUser",
...
if not administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] then
    return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم بالتأكيد الغاء حظره ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_* ['..data.id_..']*', 0, "md")
   end
administration[tostring(arg.chat_id)]['banned'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)
channel_unblock(arg.chat_id, data.id_)
return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم الغاء حظره ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_* ['..data.id_..']*', 0, "md")
end
tdcli_function ({
    ID = "GetUser",
    user_id_ = data.sender_user_id_
...
if administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] then
     return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم بالتأكيد كتمه ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_* ['..data.id_..']*', 0, "md")
   end
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = user_name
    save_data(_config.moderation.data, administration)
     return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم كتمه ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_* ['..data.id_..']*', 0, "md")
end
tdcli_function ({
    ID = "GetUser",
    user_id_ = data.sender_user_id_
...
if not administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] then
     return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم بالتاكيد الغاء كتمه ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_* ['..data.id_..']*', 0, "md")
   end
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)
     return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم الغاء كتمه ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_* ['..data.id_..']*', 0, "md")
end
tdcli_function ({
    ID = "GetUser",
    user_id_ = data.sender_user_id_
...
if is_gbanned(data.id_) then
     return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _  تم بالتأكيد حظره عام ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_* ['..data.id_..']*', 0, "md")
   end
  administration['gban_users'][tostring(data.id_)] = user_name
    save_data(_config.moderation.data, administration)
   kick_user(data.id_, arg.chat_id)
     return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم حظره عام  ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║  _الايدي_* ['..data.id_..']*', 0, "md")
end
tdcli_function ({
    ID = "GetUser",
    user_id_ = data.sender_user_id_
...
if not is_gbanned(data.id_) then
     return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم بالتأكيد الغاء حظره العام ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_ * ['..data.id_..']*', 0, "md")
   end
  administration['gban_users'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)
     return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم الغاء حظره العام ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_ * ['..data.id_..']*', 0, "md")
end
tdcli_function ({
    ID = "GetUser",
    user_id_ = data.sender_user_id_
...
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = user_name
  ...
  if cmd == "unsilent" then
if not administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] then
    return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم بالتأكيد الغاء كتمه ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_ *['..data.id_..']*', 0, "md")
   end
administration[tostring(arg.chat_id)]['is_silent_users'][tostring(data.id_)] = nil
    save_data(_config.moderation.data, administration)
     return tdcli.sendMessage(arg.chat_id, "", 0, '🌐║ _ تم بالتأكيد الغاء كتمه ☑️_\n🌐║ _العضو_ ['..user_name..'] \n🌐║ _الايدي_ *['..data.id_..']*', 0, "md")
...
kick_user(data.id_, arg.chat_id)
  sleep(1)
channel_unblock(arg.chat_id, data.id_)
tdcli.sendMessage(arg.chat_id, arg.msg_id, 0, "🌐║ تم طرد العضو "..check_markdown(user_name).."","md")
end
end
...
tdcli.sendMessage(msg.chat_id_, msg.id, 0, "🌐║ تم طرد العضو [`"..matches[2].."`]","md")
end
   end
...
if not matches[2] and msg.reply_id then
  ...
  return tdcli.sendMessage(msg.to.id, "", 0, '🌐║ _ تم بالتأكيد حظره عام ☑️_\n🌐║ _الايدي_ *('..matches[2]..')*', 0, "md")
     end
  data['gban_users'][tostring(matches[2])] = ""
    save_data(_config.moderation.data, data)
kick_user(matches[2], msg.to.id)

 return tdcli.sendMessage(msg.to.id, "", 0, '🌐║ _ تم حظره عام ☑️_\n🌐║ _الايدي_ *('..matches[2]..')*', 0, "md")
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.to.id, "", 0, '🌐║ _ تم حظره عام ☑️_ _الايدي_ *['..matches[2]..']*\n🌐║ _ تم حظره عام ☑️_ _ تم بالتأكيد الغاء حظره العام ☑️_', 0, "md")
     end
  data['gban_users'][tostring(matches[2])] = nil
    save_data(_config.moderation.data, data)
return tdcli.sendMessage(msg.to.id, "", 0, '🌐║ _ تم الغاء حظره العام ☑️_\n🌐║ _الايدي_ *['..matches[2]..']*', 0, "md")
   end
  if matches[2] and string.match(matches[2], '@[%a%d_]') then
    tdcli_function ({
      ID = "SearchPublicChat",
...
data[tostring(chat)]['banned'][tostring(matches[2])] = ""
    save_data(_config.moderation.data, data)
kick_user(matches[2], msg.to.id)
 return tdcli.sendMessage( msg.to.id, "", 0, '🌐║ _ تم حظره ☑️_\n🌐║ _الايدي_ *['..matches[2]..']*', 0, "md")
   end
  if matches[2] and string.match(matches[2], '@[%a%d_]') then
     tdcli_function ({
      ID = "SearchPublicChat",
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.to.id, "", 0, '🌐║ _ تم بالتأكيد الغاء حظره ☑️_\n🌐║ _الايدي_ *['..matches[2]..']*', 0, "md")
     end
data[tostring(chat)]['banned'][tostring(matches[2])] = nil
    save_data(_config.moderation.data, data)
channel_unblock(msg.to.id, matches[2])
return tdcli.sendMessage(msg.to.id, "", 0, '🌐║ _ تم الغاء حظره ☑️_\n🌐║ _الايدي_ *['..matches[2]..']*', 0, "md")
...
if not matches[2] and msg.reply_id then
  ...
  if matches[2] and string.match(matches[2], '^%d+$') then
   ...
   return tdcli.sendMessage(msg.to.id, "", 0, '🌐║ _ تم بالتأكيد كتمه ☑️_\n🌐║ _الايدي_ *['..matches[2]..']*', 0, "md")
     end
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = ""
    save_data(_config.moderation.data, data)
return tdcli.sendMessage(msg.to.id, "", 0, '🌐║ _ تم كتمه ☑️_\n🌐║ _الايدي_ *['..matches[2]..']*', 0, "md")
   end
  if matches[2] and string.match(matches[2], '@[%a%d_]') then
    tdcli_function ({
      ID = "SearchPublicChat",
...
data[tostring(chat)]['is_silent_users'][tostring(matches[2])] = nil
    save_data(_config.moderation.data, data)
return tdcli.sendMessage(msg.to.id, "", 0, '🌐║ _الايدي_ *['..matches[2]..']*\n🌐║ _ تم بالتأكيد الغاء كتمه ☑️_ _ تم الغاء كتمه ☑️_', 0, "md")
   end
  if matches[2] and string.match(matches[2], '@[%a%d_]') then
   tdcli_function ({
      ID = "SearchPublicChat",
